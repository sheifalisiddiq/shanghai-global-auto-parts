...
// Route handler (not the opengraph-image file convention) on purpose: the file
// convention is inherited by every route under app/, which would put og:image
// tags on /admin. This keeps the same public URL: /opengraph-image.
